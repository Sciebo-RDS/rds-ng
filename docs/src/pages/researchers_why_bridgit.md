---
title: Why Bridgit?
description: Why you should use bridgit as a researcher
...
By combining these capabilities in one platform, *bridgit* empowers researchers at universities to save time, reduce administrative burden, and ensure that their data is secure, <ins>FAIR</ins>-compliant, and ready for long-term reuse and impact.
...
No problem! *bridgit* is still in beta, and we are continuously working to connect more services to meet the needs of researchers like you. If you want to use a repository that isn’t available yet, simply send us an email at [sciebo.rds@uni-muenster.de](mailto:sciebo.rds@uni-muenster.de).
