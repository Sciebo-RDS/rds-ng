...
export class ListResourcesAction extends FrontendCommandAction<ListResourcesCommand, CommandComposer<ListResourcesCommand>> {
    public prepare(
        ...
        this._composer = ListResourcesCommand.build(this.messageBuilder, root, includeFolders, includeFiles, recursive);
    ...
    protected addDefaultNotifiers(): void {
        ...
        this.addNotifier(
            ...
            new OverlayNotifier(
                ...
                `An error occurred while downloading your resources list: ${ActionNotifier.MessagePlaceholder}.`,
                true,
            ),
        );
    }
