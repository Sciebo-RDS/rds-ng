...
def get_stub_data_projects() -> typing.List[Project]:
    ...
    return [
        ...
        Project(
            project_id=1001,
            creation_time=time.time(),
            resources_path="/files/science_proj",
        ...
        Project(
            project_id=1002,
            creation_time=time.time(),
            resources_path="/files/not_existing",
            title="This is crap",
        ...
        Project(
            project_id=1003,
            creation_time=time.time(),
            resources_path="/files/science_proj/img",
