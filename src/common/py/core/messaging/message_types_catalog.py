...
class MessageTypesCatalog:
    _message_types: typing.Dict[MessageName, typing.Type[MessageType]] = {}

    @staticmethod
    def register_type(name: MessageName, msg_type: typing.Type[MessageType]) -> None:
    ...
    @staticmethod
    def find_type(name: MessageName) -> typing.Type[MessageType] | None:
