...
ARG     COMPONENT_NAME
ARG     COMPONENT_LOCATION="${COMPONENT_NAME}"
ARG     COMPONENT_ADDITIONAL_LOCATION="/<invalid>"
...
COPY    /src/${COMPONENT_LOCATION} ./${COMPONENT_LOCATION}
COPY    /src/${COMPONENT_ADDITIONAL_LOCATION}* ./${COMPONENT_LOCATION}
COPY    /src/${COMPONENT_ADDITIONAL_LOCATION}* ./${COMPONENT_ADDITIONAL_LOCATION}

ENV     PYTHONPATH="/component"

# Run the container
WORKDIR /component/${COMPONENT_LOCATION}

ENV     COMPONENT_NAME=${COMPONENT_NAME}
ENV     COMPONENT_LOCATION=${COMPONENT_LOCATION}
