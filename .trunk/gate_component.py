...
comp = BackendComponent(UnitID("infra", "gate"), NodeRole(), module_name=__name__)
app = comp.app()
...
def h(msg: MyEvent, ctx: ServiceContext) -> None:
    ...
    ctx.message_emitter.emit_command(
        MyCommand,
        Channel.direct("infra/testbuddy/default"),
        done_callback=h2_done,
        fail_callback=h2_fail,
